...
function shoot_point_defence(_shooter, _range) {
...
function shoot_drain_shields(_shooter, _target) {
  ...
  drain_blob.set_shield_drainer(
    _target, _shooter, 0.1
  );
}

function draw_beam(_shooter, _target, _width = 1, _color1, _color2, _muzzle_particle, _impact_particle, _lifespan = 15, _alpha = 1) {
